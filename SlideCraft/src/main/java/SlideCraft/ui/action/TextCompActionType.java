...
//  *
//  */
// public enum TextCompActionType {
...
//         @Override
//         public boolean isEnabled(JTextComponent component) {
//             boolean result = component != null && component.isEnabled() && component.isEditable()
...
//         @Override
//         public boolean isEnabled(JTextComponent component) {
//             boolean result = component != null && component.isEnabled() && component.getText() != null
...
//     private TextCompActionType(TextComponentAction action) {
//         this.name = String.format("slidecraft.text.%s_action", this.name().toLowerCase());
//         this.action = action;
//     }
...
//         for (TextCompActionType type : values()) {
